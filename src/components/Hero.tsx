...
/*
  MoneyTracker Hero Section - Design Plan:
  -----------------------------------------
  1. Scrim/Contrast:
...
export default function Hero() {
  ...
  const [activeTab, setActiveTab] = useState<'all' | 'spending' | 'budget'>('all');
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      // Pause updates if the document is backgrounded/inactive to save CPU/battery
